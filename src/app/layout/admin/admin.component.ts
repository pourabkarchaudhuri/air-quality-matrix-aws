...
@Component({
  ...
  providers:[ DashboardDefaultComponent, ConfigService ],
  animations: [
...
/*  @ViewChild('toggleButton') toggle_button: ElementRef;
  ...
  constructor(public menuItems: MenuItems, private dashboard: DashboardDefaultComponent, private router: Router) {
    this.navType = 'st2';
  ...
  public search(): void {
    ...
    this.dashboard.getDataByCity(this.city);
